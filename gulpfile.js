...
gulp.task('default', ['clean'], function () {
    gulp.start('extend', 'iconfont', 'css', 'pic', 'js', 'watch');
});
...
// });
// gulp.task('extend', ['extend:build'], function (done) {
//     done();
// });
gulp.task('extend:build', function buildHTML() {
